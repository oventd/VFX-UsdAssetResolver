...
class ResolverContext:
    ...
    def ResolveAndCache(context, assetPath):
        ...
        print(assetPath, type(assetPath), show, shot)
        if assetPath.startswith("rsrc:/"):
            relative_path = assetPath[len("rsrc:/"):].lstrip("/")
            ...
            # Default fallback — optionally let default resolver handle it
